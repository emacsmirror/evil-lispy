...
| [[http://oremacs.com/lispy/#lispy-flow][i]] | Go _in_ the current expression, or move past it if not possible   |
| [[http://oremacs.com/lispy/#lispy-tab][f]] | Indent or _fix_ the current expression                            |
| [[http://oremacs.com/lispy/#lispy-different][o]] | Switch to the _other_ side of the current expression or selection |
